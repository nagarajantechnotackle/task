...
const services: Service[] = [
  ...
  { name: "Major Repairs", image: "serviceImage2" },
];
    ...
    <div className="mx-auto p-4 bg-white shadow-md">
      <div className="flex items-start bg-gradient-to-r from-blue-600 to-purple-600 text-white  rounded-xl border border-blue-400 shadow-md">
        ...
        <div className="flex-1 py-4">
          <h3 className="text-[16px] font-openSans font-semibold">
            Maruti Swift
          </h3>
      ...
      {services.map((service) => (
        <div key={service.name} className="mt-3 rounded-lg overflow-hidden">
          <button
            ...
            <span
              className={
                openService === service.name
                  ? "flex items-center gap-2 bg-gradient-to-r from-[#0060EF] via-[#150190] to-[#8601F0] bg-clip-text text-transparent"
              ...
              {openService === service.name ? (
                ...
                >
                  <path
                    ...
                    stroke="url(#paint0_linear_87141_118)"
                    stroke-width="1.5"
                  ...
                  <path
                    ...
                    stroke="url(#paint1_linear_87141_118)"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
          ...
          {openService === service.name && service.subServices && (
            <div className="pt-3 bg-[rgba(249,249,251,1)]">
              {service.subServices.map((sub) => (
                <div
                  key={sub.title}
                  className="p-3 border rounded-md border-[rgba(243,243,246,1)] mb-2"
                >
                  <div className="flex justify-between flex-wrap">
                    <h4 className="font-semibold text-black text-[16px] font-openSans">
                      {sub.title}
                    </h4>
